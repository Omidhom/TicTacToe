...
class MainActivity : AppCompatActivity() {
    ...
    fun imageButtonTapped(view: View) {
        ...
        when (randomNumber) {
            ...
            5 -> tableLayout.setBackgroundColor(Color.YELLOW)
            6 -> tableLayout.setBackgroundColor(Color.BLUE)
            7 -> tableLayout.setBackgroundColor(Color.RED)
            8 -> tableLayout.setBackgroundColor(Color.BLACK)
...
//            playingplayer = PLAYINGPLAYER.FIRST_PLAYER
    ...
    private fun specifyTheWinnerOfGame() {
        ...
        if(winnerOfGame == WINNER_OF_GAME.PLAYER_ONE) {
            ...
            "Congratulations to Player 1", AlertDialog.BUTTON_POSITIVE,
            "OK", false)
            return
            ...
            createAlert("Player Two Wins",
                    "Congratulations to Player 2", AlertDialog.BUTTON_POSITIVE,
                    "OK", false)
            return
        }
    ...
    private fun checkDrawState() {
        ...
        if(allDisabledImages.size == 9 && winnerOfGame != WINNER_OF_GAME.PLAYER_ONE
                && winnerOfGame != WINNER_OF_GAME.PLAYER_TWO) {
            createAlert("DRAW!!!", "No one won the game" , AlertDialog.BUTTON_POSITIVE,
                    "OK" , false)
        }
